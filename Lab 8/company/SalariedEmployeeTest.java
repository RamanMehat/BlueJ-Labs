...
public class SalariedEmployeeTest
{
    ...
    {       
        ...
        salaried2.setAnnualSalary(80000);
        assertEquals(true, salaried1.hasSameID(salaried2));
        assertEquals(true, salaried1.hasSameID(salaried1));
        
        HourlyEmployee hourlyEm1 = new HourlyEmployee("Harry Hacker", 111222);
        hourlyEm1.setHoursWorked(15);
        hourlyEm1.setHoursWorked(20);
        assertEquals(false, salaried1.hasSameID(hourlyEm1));
    }
}
