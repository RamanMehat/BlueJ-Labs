...
public class HourlyEmployeeTest
{
    ...
    {       
        HourlyEmployee hourlyEm2 = new HourlyEmployee("HarryHacker", 111222);
        hourlyEm2.setHoursWorked(15);
        hourlyEm2.setHourlyWage(20);
        assertEquals(true, hourlyEm1.hasSameID(hourlyEm2));
        assertEquals(true, hourlyEm1.hasSameID(hourlyEm1));
        
        SalariedEmployee salaried1 = new SalariedEmployee("Cathy Coder", 123456);
        salaried1.setAnnualSalary(60000);        
        
        assertEquals(false, hourlyEm1.hasSameID(salaried1));
    }    
}
